...
const {Obj_Shape, Subdivision_Sphere} = defs;
...
export default class Fragment{
    ...
    render(context, program_state, model_transform=Mat4.identity(), size = 1, spawn_num = 0, speed = 1, t) {
        ...
        for(let i = 0; i < spawn_num; i++){
            if(this.randomize)
                center_transform = center_transform.times(Mat4.rotation(Math.random(), Math.random(), Math.random()));
            ...
            let rock_transform = center_transform.times(Mat4.translation(x, y, z));
